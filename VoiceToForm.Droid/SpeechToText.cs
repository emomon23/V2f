        ...
        private void LaunchSpeechToText()
        {
            ...
            { 
                ...
                else
                {
                    ...
                    // if there is more then 2.5s of silence, consider the speech over
                    int doneSpeakingSecondsInterval = 6000;
                    
                    voiceIntent.PutExtra(RecognizerIntent.ExtraSpeechInputCompleteSilenceLengthMillis, doneSpeakingSecondsInterval);
                    voiceIntent.PutExtra(RecognizerIntent.ExtraSpeechInputPossiblyCompleteSilenceLengthMillis, doneSpeakingSecondsInterval);
                    voiceIntent.PutExtra(RecognizerIntent.ExtraSpeechInputMinimumLengthMillis, doneSpeakingSecondsInterval);
                    voiceIntent.PutExtra(RecognizerIntent.ExtraPrompt, "Speak to field");
